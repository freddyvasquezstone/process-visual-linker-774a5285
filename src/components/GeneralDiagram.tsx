...
import { generalDiagram } from '../data/processData';

const GeneralDiagram = () => {
  return (
    <div className={`mb-10 p-6 rounded-xl shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${generalDiagram.bgClass}`}>
